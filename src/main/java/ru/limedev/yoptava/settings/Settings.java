...
final class Settings {
    ...
    static final Language LANGUAGE_TYPE_GOPTAVA = LanguageType.GOPTAVA.language;
    ...
    static final Language LANGUAGE_TYPE_LEPTAVA = LanguageType.LEPTAVA.language;
    ...
    static final Language LANGUAGE_TYPE_RUPTAVA = LanguageType.RUPTAVA.language;
